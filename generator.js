...
function display()
{
	...
	for(var it of selected)
	{
		if(r < it.p)
		{
			...
			switch(paramPassed)
			{
				case 1: ctx.fillRect(point[0]*75 + 200, 401-(point[1]*40), 1, 1);
						break;
				case 3: ctx.fillRect(point[0]*75 + 200, 375-(point[1]*53), 1, 1);
						break;
				case 4: ctx.fillRect(point[0]*75 + 200, 390-(point[1]*45), 1, 1);
						break;
				case 5: ctx.fillRect(point[0]*75 + 200, 390-(point[1]*65), 1, 1);
						break;
				case 6: ctx.fillRect(point[0]*510, 401-(point[1]*400), 1, 1);
						break;
				case 7: ctx.fillRect(point[0]*700 + 200, 370-(point[1]*700), 1, 1);
						break;
				case 8: ctx.fillRect(point[0]*75 + 200, 385-(point[1]*58), 1, 1);
						break;
			}
			break;
		}
